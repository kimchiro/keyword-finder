...
__decorate([
    ...
    __metadata("design:type", Number)
], GenderSearchRatios.prototype, "maleRatio", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: '여성 검색 비율' }),
    (0, typeorm_1.Column)({ name: 'female_ratio', type: 'decimal', precision: 5, scale: 2, default: 0 }),
    __metadata("design:type", Number)
], GenderSearchRatios.prototype, "femaleRatio", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: '분석 날짜' }),
    (0, typeorm_1.Column)({ name: 'analysis_date', type: 'date' }),
    __metadata("design:type", Date)
], GenderSearchRatios.prototype, "analysisDate", void 0);
__decorate([
